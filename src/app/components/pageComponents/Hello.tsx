...
export default function Hello() {
   ...
   return <div className={`relative bg-cover bg-center bg-no-repeat py-16 lg:py-36 `} style={{ backgroundImage: `url(${ desktop5.src })`, }}>
				
      <div className="absolute inset-0 z-10 opacity-85 bg-gradient-to-r from-blue-700 to-cyan-500 bg-cover bg-center bg-no-repeat" />

      <div className='  relative z-10 m-auto'>
         <div className='flex flex-col lg:flex-row justify-center items-center '>
            
            <div className={`bg-cover bg-center bg-no-repeat h-44 w-44 z-0 sm:h-48 sm:w-48  md:h-64 md:w-64 rounded-full border-2 border-blue-700 shadow-xl fadeUpCustom` } style={{ backgroundImage: `url(${ avatar.src })`, }} >
            </div>
